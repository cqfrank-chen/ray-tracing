...
Vector3f Scene::castRay(const Ray &ray, int depth) const
{
    ...
    float distanscePow2 = obj2light.x * obj2light.x + obj2light.y * obj2light.y + obj2light.z * obj2light.z;
    ...
    {
        ldir = lightInter.emit * objectInter.m->eval(ray.direction, obj2lightdir, objectInter.normal) * dotProduct(-obj2lightdir, lightInter.normal) / distanscePow2 / lightPdf;
    }
